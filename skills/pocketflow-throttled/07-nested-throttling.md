---
name: "nested-throttling"
description: "Combine flow and node-level rate limits. Use for complex pipelines with multiple API calls per item."
---

# Skill 07: Nested Throttling

**Difficulty**: Advanced
**Source**: `cookbook/rate_limited_llm_batch/nested_example.py`
